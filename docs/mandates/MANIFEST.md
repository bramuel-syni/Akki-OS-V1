...
| `RMS_UI_Specification_v1.md` | `501d36c59aaf2bc0abba256380d00f848899e158df24a4cd9e23a5de512d1cc8` | 2026-07-03T21:03Z | https://customer-assets.emergentagent.com/job_build-metrics-10/artifacts/380770m1_RMS_UI_Specification_v1.md | RMS UI Specification v1 — binding surface spec; supersedes the G5b-era `RMS_Interface_Specification.md` (v1.0). Figures and names are illustrative only; §8 binding copy set is BINDING. |

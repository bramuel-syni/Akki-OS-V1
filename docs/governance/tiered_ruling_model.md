...
EAB Tier-1 Adoption Spec v1.0 in force as requirements canon; build phases EAB-1/2/3 dispatch on Owner-lane sequencing after G-2 and G-3 close; Part VII folds into Operating Values v1.1 at G-3; boundary clauses §1.2 binding on all future Stage As (batch-subordination · no-scheduler-beside-Targeta). Artifact at `docs/requirements/eab_tier1_adoption_spec_v1.1.md` SHA-256 `312427c672e9db8a9bda83f5b0db79218c46b7f14085233ce974671d259571c9`.

...
## CI
`pytest -q` = **685/685** green at 2026-07-04 (Phase 7 Stage B-2 close). Delta from Phase 7 Stage B-1 (613): +72 (Block A pre-LLM Guard-1 mandatory-tier 11 gates + Block B Sonnet 4.6 inside Shield 7 LLM gates + Block C buyer SM + router + dual-delta + Condition-2 single-source + byte-identity 26 + regressions 54 gates including 26-file byte-identity parametrisation).
